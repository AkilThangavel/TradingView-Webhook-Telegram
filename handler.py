...
def send_alert(data):
    msg = (data["strategy"]["order_action"]+ "Order#### " + "Ticker - " + data["ticker"] + ", Exchange - " + data["exchange"]+ ", Order price -" + data["strategy"]["order_price"] + ", Market Position - " + data["strategy"]["market_position"])
